...
import { ISessionTag } from "../session";
import BlockProxy from "./block-proxy";
import { VCSBlockId, VCSTagId, VCSTagInfo } from "../../provider";

export default class TagProxy extends DatabaseProxy implements ISessionTag {
