...
import { SideScrollVersionList } from "../../../views/basics/version-list"
import Button from "../../../views/basics/button"
import VCSVersion from "../../../data-types/version"

export default class GhostSnapshotHeader extends InlineEditorBanner {
    ...
    private createAddButton(container: HTMLElement): void {
        ...
        Button.addButton(addButtonDiv, async () => { 
