import { MonacoEditor, MonacoModel, LayoutInfo } from "../../../data-types/convenience/monaco"
...
import LineLocator, { RangeProvider } from "../../../utils/line-locator"
import SubscriptionManager from "../../../utils/subscription-manager"
import MetaView from "../../meta-view"
import { VCSBlockId, VCSBlockInfo, VCSBlockRange, VCSBlockSession, VCSTagInfo } from "../../../../vcs/provider"
import VCSSnapshot from "../../../data-types/snapshot"
import VCSVersion from "../../../data-types/version"
import { throttle } from "../../../utils/helpers"

export default class GhostSnapshot extends SubscriptionManager implements RangeProvider {
    ...
    private display(): void {
        ...
        this.addSubscription(this.highlight.onDidChange(() => {
