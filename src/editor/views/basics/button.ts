...
import { VersionViewContainer, VersionViewElement } from "../versions/version-view"
import SubscriptionManager from "../../utils/subscription-manager"
import P5JSPreview from "../previews/p5js-preview"
import Synchronizer from "../../utils/synchronizer"
import VCSVersion from "../../data-types/version"

export default class Button extends SubscriptionManager {
    ...
    public onClick(callback: (button: Button) => void): Disposable {
        ...
        return this.addSubscription({
            dispose: () => {
                const index = this.onClickCallbacks.indexOf(callback, 0)
                if (index > -1) { this.onClickCallbacks.splice(index, 1) }
            }
        })
    }
