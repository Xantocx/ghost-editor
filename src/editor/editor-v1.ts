...
import { MonacoEditor, Disposable, MonacoModel, URI, Selection, IRange } from "./utils/types"
...
export class GhostEditorV1 implements ReferenceProvider {
...
if (editorElement) {
    const editor = new GhostEditorV1(editorElement)
} else {
