...
export class GhostHighlightDecoration extends MouseTracker {
        ...
        return [
            {
                ...
                options: {
                    isWholeLine: true,
                    className: `ghostHighlightTop ${parent.uuid}`,
            ...
            },
            {
                ...
                options: {
                    isWholeLine: true,
                    className: `ghostHighlightMid ${parent.color} ${parent.uuid}`,
            ...
            },
            {
                ...
                options: {
                    isWholeLine: true,
                    className: `ghostHighlightBottom ${parent.uuid}`,
                    stickiness: monaco.editor.TrackedRangeStickiness.NeverGrowsWhenTypingAtEdges
                },
            },
        ]
